...
The empty Azure free-trial subscription remains Enabled with its spending limit On. Cancelling the subscription itself was blocked by automatic approval review pending explicit user authorization; it has not been cancelled. There is no remaining Azure-hosted website or provisioned resource.
